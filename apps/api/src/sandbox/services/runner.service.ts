...
export class RunnerService {
   ...
   */
  async findReadyRunnerWithMinScore(minAvailabilityScore: number, regionId?: string): Promise<Runner | null> {
  ...
  /**
   * Find ready runners with minimum availability score and schedulable=true in custom regions.
   */
  async findReadyRunnersWithMinScoreAndCustomRegion(
