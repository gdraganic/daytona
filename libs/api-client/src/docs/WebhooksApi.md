...
|------------- | ------------- | -------------|
|[**webhookControllerGetAppPortalAccess**](#webhookcontrollergetappportalaccess) | **POST** /webhooks/organizations/{organizationId}/app-portal-access | Get Svix Consumer App Portal access URL for an organization|
