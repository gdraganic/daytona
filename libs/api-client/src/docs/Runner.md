...
**gpu** | **number** | The GPU capacity of the runner | [default to undefined]
**gpuType** | **string** | The type of GPU | [default to undefined]
**_class** | [**SandboxClass**](SandboxClass.md) | The class of the runner | [default to undefined]
...
**version** | **string** | The version of the runner | [default to undefined]
